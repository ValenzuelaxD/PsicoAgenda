...
export function Sidebar({ currentView, userType, onNavigate, onLogout, isMobile = false }: SidebarProps) {
  ...
  const containerClass = isMobile
    ? 'w-full h-full min-h-0 bg-gradient-to-b from-slate-800 to-slate-900 flex flex-col z-50 overflow-y-scroll'
    : 'hidden sm:flex fixed left-0 top-0 h-[100dvh] w-64 bg-gradient-to-b from-slate-800 to-slate-900 border-r border-slate-700 flex flex-col shadow-2xl z-50 overflow-y-scroll';
